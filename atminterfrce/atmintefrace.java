...
import javax.swing.*;
class Framework1 extends Thread{
    public void run()
        {
            int check=0;
           JFrame f1 =new JFrame();
            ...
            panel1.setBounds(1000, 500, 700, 450); 
               ...
               if(check==0){
                 try{
                    ...
                    l2.setText("  "+sec);
                        ...
                        Connection con=DriverManager.getConnection("jdbc:mysql://192.168.71.234:3306/atm","andro","Mathan@22");  
                        Statement stmt=con.createStatement();  
                        ResultSet rs=stmt.executeQuery("select * from atm");  
                        while(rs.next())  {
                        int s1 = Integer.parseInt(rs.getString(3));
                        if(s1!=0){
                            check=1;
                        }  
                        }
        ...
        void SecondPage()
        {
            ...
            b1.addActionListener(new ActionListener() {
                public void actionPerformed(ActionEvent e) {
                    ...
                    try {
                        Connection conn = (Connection) DriverManager.getConnection("jdbc:mysql://192.168.71.234:3306/upi", "andro"
                                ,"Mathan@22");
        ...
        void ThirdPage(){
            ...
            b12.addActionListener(new ActionListener() {
                public void actionPerformed(ActionEvent e) {
                    try{
                        Class.forName("com.mysql.jdbc.Driver");  
                        Connection con=DriverManager.getConnection("jdbc:mysql://192.168.71.234:3306/upi","andro","Mathan@22");  
                        String query = "insert into recieve_"+phone_no+" values('atm01@hdfcbank','ATM',"+amt+")";
